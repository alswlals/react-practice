...
2. 설치
   v14.4.0 을 설치하고 설치 위치는 /usr/local/douzone2023/node-v14.4.0 이다.

   ```bash
   # wget https://nodejs.org/dist/v14.4.0/node-v14.4.0.tar.gz
   # tar xvfz node-v14.4.0.tar.gz
   # ./configure --prefix=/usr/local/douzone2023/node-v14.4.0
   # make & make install
   ```
...
3. 링크 작업
   ...
   ```bash
   # ln -s /usr/local/douzone2023/node-v14.4.0 /usr/local/douzone2023/node
   ```
